        ...
        <div class="col-md-3">
            <div class="card text-center shadow rounded-4">
                <div class="card-body py-5">
                    ...
                    <a href="Usuario/Listar" class="btn btn-primary w-100">
                        Entrar
                    </a>
        ...
        <div class="col-md-3">
            <div class="card text-center shadow rounded-4">
                <div class="card-body py-5">
                    ...
                    <a href="Usuario/Registrar" class="btn btn-primary w-100">
                        Entrar
                    </a>
        ...
        <div class="col-md-3">
            <div class="card text-center shadow rounded-4">
                <div class="card-body py-5">
                    ...
                    <a href="Usuario/Buscar" class="btn btn-primary w-100">
                        Entrar
                    </a>
