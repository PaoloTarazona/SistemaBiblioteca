...
<div class="container mt-4">
    ...
    <div class="text-center mb-5">
        <h2 class="fw-bold">GESTION DE CLIENTES</h2>
        ...
        <div class="col-md-3">
            <div class="card text-center shadow rounded-4">
                <div class="card-body py-5">
                    ...
                    <a href="<%= request.getContextPath() %>/Inicio/Cliente/Listar" class="btn btn-primary w-100">
                        Entrar
                    </a>
        ...
        <div class="col-md-3">
            <div class="card text-center shadow rounded-4">
                <div class="card-body py-5">
                    ...
                    <a href="<%= request.getContextPath() %>/Inicio/Cliente/Registrar" class="btn btn-primary w-100">
                        Entrar
                    </a>
        ...
        <div class="col-md-3">
            <div class="card text-center shadow rounded-4">
                <div class="card-body py-5">
                    ...
                    <a href="<%= request.getContextPath() %>/Inicio/Cliente/Buscar" class="btn btn-primary w-100">
                        Entrar
                    </a>
