...
List<Usuario> lsUsuarios = (List<Usuario>) request.getAttribute("listaUsuarios");
%>
<!-- Navbar -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4">
        <div class="container-fluid">
            <a class="navbar-brand" href="<%= request.getContextPath() %>/InicioF">Sistema de Biblioteca</a>
            <div class="d-flex">
