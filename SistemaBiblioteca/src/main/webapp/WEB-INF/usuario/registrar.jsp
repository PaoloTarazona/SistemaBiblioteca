...
<%@ page import="java.util.List, app.modelos.Rol"%>
<%
...
<div class="container mt-4">
    ...
    <form action="Registrar" method="POST" name="fRegistro">
        ...
        <input type="text" id="nombreUsuario" name="nombreUsuario" class="form-control mb-3" required maxlength="100">

        <label for="nombre" class="form-label">Nombre:</label>
        <input type="text" id="nombre" name="nombre" class="form-control mb-3" required maxlength="100">

        <label for="apellido" class="form-label">Apellido:</label>
        <input type="text" id="apellido" name="apellido" class="form-control mb-3" required maxlength="50">

        <label for="contrasena" class="form-label">Contraseña:</label>
        <input type="password" id="contrasena" name="contrasena" class="form-control mb-3" min="0" required>
